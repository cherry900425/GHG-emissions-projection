...
library(msm)
library(readxl)
data_gdp <- read_excel("E:/Data1_update/data_original.xlsx", sheet="gdp",col_types = c("numeric","numeric",
...
data_fh <- read_excel("E:/Data1_update/data_original.xlsx", sheet="fh",col_types = c("text",
                                                                                "numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_fv <- read_excel("E:/Data1_update/data_original.xlsx", sheet="fv",col_types = c("text",
                                                                              "numeric","numeric",
                                                                              "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_fg <- read_excel("E:/Data1_update/data_original.xlsx", sheet="fg",col_types = c("text",
                                                                              "numeric","numeric",
                                                                              "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_s <- read_excel("E:/Data1_update/data_original.xlsx", sheet="s",col_types = c("text",
                                                                                "numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_v <- read_excel("E:/Data1_update/data_original.xlsx", sheet="v",col_types = c("text",
                                                                                "numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_g <- read_excel("E:/Data1_update/data_original.xlsx", sheet="g",col_types = c("text",
                                                                                "numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_y <- read_excel("E:/Data1_update/data_original.xlsx", sheet="y",col_types = c("text",
                                                                                "numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
data_p <- read_excel("E:/Data1_update/data_original.xlsx", sheet="pop",col_types = c("numeric","numeric",
                                                                                "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                                "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
...
data_r <- read_excel("E:/Data1_update/data_R.xlsx", sheet="ratio",col_types = c("numeric","numeric",
                                                                              "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
                                                                              "numeric","numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
...
################emission intensity and consumption patterns####################################################
...
################projecion of reference for emission intensity####################################################
j=33
...
################projecion of emissions for 24 europe countries####################################################
...
pred_o1_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o2_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o3_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o4_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o5_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o6_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o7_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
pred_o_euro<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
...
for (j in 1:24){
  ...
  pred_o1 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o2 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o3 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o4 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o5 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o6 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  pred_o7 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = n_2050-1)
  
  for (i in 1:nrow(lm1_mcmc_fh)){
    for (t in 2:n_2050){
      pred_o1[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s1[i,t-1])
      pred_o2[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s2[i,t-1])
      pred_o3[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s3[i,t-1]+pred_norm_y2[i,t-1]*pred_norm_v1[i,t-1])
      pred_o4[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s4[i,t-1]+pred_norm_y2[i,t-1]*pred_norm_v2[i,t-1])
      pred_o5[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s5[i,t-1]+pred_norm_y2[i,t-1]*pred_norm_v3[i,t-1])
      pred_o6[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y1[i,t-1]*pred_norm_s6[i,t-1]+pred_norm_y2[i,t-1]*pred_norm_v4[i,t-1]+pred_norm_y3[i,t-1])
      pred_o7[i,t-1]<-pred_p[i,t]*pred_gdp[i,t]*(pred_norm_y2[i,t-1]*pred_norm_v5[i,t-1])
    }
  }
  
  for (i in 1:nrow(lm1_mcmc_fh)){
    for (t in 1:n_2050-1){
      pred_o1_euro[i,t]<-pred_o1_euro[i,t]+pred_o1[i,t]
      pred_o2_euro[i,t]<-pred_o2_euro[i,t]+pred_o2[i,t]
      pred_o3_euro[i,t]<-pred_o3_euro[i,t]+pred_o3[i,t]
      pred_o4_euro[i,t]<-pred_o4_euro[i,t]+pred_o4[i,t]
      pred_o5_euro[i,t]<-pred_o5_euro[i,t]+pred_o5[i,t]
      pred_o6_euro[i,t]<-pred_o6_euro[i,t]+pred_o6[i,t]
      pred_o7_euro[i,t]<-pred_o7_euro[i,t]+pred_o7[i,t]
    }
  }
  ...
  fac_t1<- matrix(NA, nrow = nrow(lm1_mcmc_y),ncol=1)
  fac_t2<- matrix(NA, nrow = nrow(lm1_mcmc_y),ncol=1) 
  ...
  for (i in 1:nrow(lm1_mcmc_y)){
    fac_t1[i,]<-pred_e[i,a1]-his_e[13,j]
    fac_t2[i,]<-fac_f[i,]+fac_s[i,]+fac_y[i,]+fac_r[i,]+fac_gdp[i,]+fac_p[i,]
  }
...
for (i in 1:nrow(lm1_mcmc_y)){
  for (t in 1:n_2050-1){
    ...
    pred_o_euro[i,t]<-pred_o1_euro[i,t]+pred_o2_euro[i,t]+pred_o3_euro[i,t]+pred_o4_euro[i,t]+pred_o5_euro[i,t]+pred_o6_euro[i,t]+pred_o7_euro[i,t]
  }
}
...
cha_o1 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o2 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o3 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o4 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o5 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o6 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
cha_o7 <- matrix(NA, nrow = nrow(lm1_mcmc_y), ncol = 18)
for (i in 1:nrow(lm1_mcmc_y)){
  cha_o1[i,1]=(pred_o1_euro[i,55]-his_o[1,1])/his_o[1,1]*100
  cha_o2[i,1]=(pred_o2_euro[i,55]-his_o[2,1])/his_o[2,1]*100
  cha_o3[i,1]=(pred_o3_euro[i,55]-his_o[3,1])/his_o[3,1]*100
  cha_o4[i,1]=(pred_o4_euro[i,55]-his_o[4,1])/his_o[4,1]*100
  cha_o5[i,1]=(pred_o5_euro[i,55]-his_o[5,1])/his_o[5,1]*100
  cha_o6[i,1]=(pred_o6_euro[i,55]-his_o[6,1])/his_o[6,1]*100
  cha_o7[i,1]=(pred_o7_euro[i,55]-his_o[7,1])/his_o[7,1]*100
}
############################euro emissions########################################
...
o1_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o1_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o1_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o2_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o2_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o2_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o3_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o3_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o3_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o4_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o4_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o4_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o5_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o5_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o5_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o6_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o6_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o6_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o7_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o7_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o7_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o_upper= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o_mean= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
o_lower= as.data.frame(matrix(NA, nrow =n_2050-1,ncol=17))
...
for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o1_euro[,t])}  
uncertain_lower_reg <- apply(pred_o1_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o1_euro, MARGIN = 2, quantile, prob = 0.975)
o1_upper[,1]<- uncertain_upper_reg
o1_lower[,1]<- uncertain_lower_reg
o1_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o2_euro[,t])}  
uncertain_lower_reg <- apply(pred_o2_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o2_euro, MARGIN = 2, quantile, prob = 0.975)
o2_upper[,1]<- uncertain_upper_reg
o2_lower[,1]<- uncertain_lower_reg
o2_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o3_euro[,t])}  
uncertain_lower_reg <- apply(pred_o3_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o3_euro, MARGIN = 2, quantile, prob = 0.975)
o3_upper[,1]<- uncertain_upper_reg
o3_lower[,1]<- uncertain_lower_reg
o3_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o4_euro[,t])}  
uncertain_lower_reg <- apply(pred_o4_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o4_euro, MARGIN = 2, quantile, prob = 0.975)
o4_upper[,1]<- uncertain_upper_reg
o4_lower[,1]<- uncertain_lower_reg
o4_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o5_euro[,t])}  
uncertain_lower_reg <- apply(pred_o5_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o5_euro, MARGIN = 2, quantile, prob = 0.975)
o5_upper[,1]<- uncertain_upper_reg
o5_lower[,1]<- uncertain_lower_reg
o5_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o6_euro[,t])}  
uncertain_lower_reg <- apply(pred_o6_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o6_euro, MARGIN = 2, quantile, prob = 0.975)
o6_upper[,1]<- uncertain_upper_reg
o6_lower[,1]<- uncertain_lower_reg
o6_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o7_euro[,t])}  
uncertain_lower_reg <- apply(pred_o7_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o7_euro, MARGIN = 2, quantile, prob = 0.975)
o7_upper[,1]<- uncertain_upper_reg
o7_lower[,1]<- uncertain_lower_reg
o7_mean[,1]<- uncertain_mean_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o_euro[,t])}  
uncertain_lower_reg <- apply(pred_o_euro, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o_euro, MARGIN = 2, quantile, prob = 0.975)
o_upper[,1]<- uncertain_upper_reg
o_lower[,1]<- uncertain_lower_reg
o_mean[,1]<- uncertain_mean_reg
################projecion of emissions for other countries####################################################
...
pred_o1_global<- pred_o1_euro
pred_o2_global<- pred_o2_euro
pred_o3_global<- pred_o3_euro
pred_o4_global<- pred_o4_euro
pred_o5_global<- pred_o5_euro
pred_o6_global<- pred_o6_euro
pred_o7_global<- pred_o7_euro
...
for (j in 25:37){
  ...
  for (i in 1:nrow(lm1_mcmc_y)){
    for (t in 1:n_2050-1){
      pred_o1_global[i,t]<-pred_o1_global[i,t]+pred_o1[i,t]
      pred_o2_global[i,t]<-pred_o2_global[i,t]+pred_o2[i,t]
      pred_o3_global[i,t]<-pred_o3_global[i,t]+pred_o3[i,t]
      pred_o4_global[i,t]<-pred_o4_global[i,t]+pred_o4[i,t]
      pred_o5_global[i,t]<-pred_o5_global[i,t]+pred_o5[i,t]
      pred_o6_global[i,t]<-pred_o6_global[i,t]+pred_o6[i,t]
      pred_o7_global[i,t]<-pred_o7_global[i,t]+pred_o7[i,t]
    }
  }
  ...
  for (i in 1:nrow(lm1_mcmc_y)){
    cha_o1[i,j-23]=(pred_o1[i,55]-his_o[1,j-23])/his_o[1,j-23]*100
    cha_o2[i,j-23]=(pred_o2[i,55]-his_o[2,j-23])/his_o[2,j-23]*100
    cha_o3[i,j-23]=(pred_o3[i,55]-his_o[3,j-23])/his_o[3,j-23]*100
    cha_o4[i,j-23]=(pred_o4[i,55]-his_o[4,j-23])/his_o[4,j-23]*100
    cha_o5[i,j-23]=(pred_o5[i,55]-his_o[5,j-23])/his_o[5,j-23]*100
    cha_o6[i,j-23]=(pred_o6[i,55]-his_o[6,j-23])/his_o[6,j-23]*100
    cha_o7[i,j-23]=(pred_o7[i,55]-his_o[7,j-23])/his_o[7,j-23]*100
  }
  ...
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o1[,t])}  
  uncertain_lower_reg <- apply(pred_o1, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o1, MARGIN = 2, quantile, prob = 0.975)
  o1_upper[,j-23]<- uncertain_upper_reg
  o1_lower[,j-23]<- uncertain_lower_reg
  o1_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o2[,t])}  
  uncertain_lower_reg <- apply(pred_o2, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o2, MARGIN = 2, quantile, prob = 0.975)
  o2_upper[,j-23]<- uncertain_upper_reg
  o2_lower[,j-23]<- uncertain_lower_reg
  o2_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o3[,t])}  
  uncertain_lower_reg <- apply(pred_o3, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o3, MARGIN = 2, quantile, prob = 0.975)
  o3_upper[,j-23]<- uncertain_upper_reg
  o3_lower[,j-23]<- uncertain_lower_reg
  o3_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o4[,t])}  
  uncertain_lower_reg <- apply(pred_o4, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o4, MARGIN = 2, quantile, prob = 0.975)
  o4_upper[,j-23]<- uncertain_upper_reg
  o4_lower[,j-23]<- uncertain_lower_reg
  o4_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o5[,t])}  
  uncertain_lower_reg <- apply(pred_o5, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o5, MARGIN = 2, quantile, prob = 0.975)
  o5_upper[,j-23]<- uncertain_upper_reg
  o5_lower[,j-23]<- uncertain_lower_reg
  o5_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o6[,t])}  
  uncertain_lower_reg <- apply(pred_o6, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o6, MARGIN = 2, quantile, prob = 0.975)
  o6_upper[,j-23]<- uncertain_upper_reg
  o6_lower[,j-23]<- uncertain_lower_reg
  o6_mean[,j-23]<- uncertain_mean_reg
  
  for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o7[,t])}  
  uncertain_lower_reg <- apply(pred_o7, MARGIN = 2, quantile, prob = 0.025)
  uncertain_upper_reg <- apply(pred_o7, MARGIN = 2, quantile, prob = 0.975)
  o7_upper[,j-23]<- uncertain_upper_reg
  o7_lower[,j-23]<- uncertain_lower_reg
  o7_mean[,j-23]<- uncertain_mean_reg
...
for (i in 1:nrow(lm1_mcmc_y)){
  cha_o1[i,18]=(pred_o1_global[i,55]-his_o[1,18])/his_o[1,18]*100
  cha_o2[i,18]=(pred_o2_global[i,55]-his_o[2,18])/his_o[2,18]*100
  cha_o3[i,18]=(pred_o3_global[i,55]-his_o[3,18])/his_o[3,18]*100
  cha_o4[i,18]=(pred_o4_global[i,55]-his_o[4,18])/his_o[4,18]*100
  cha_o5[i,18]=(pred_o5_global[i,55]-his_o[5,18])/his_o[5,18]*100
  cha_o6[i,18]=(pred_o6_global[i,55]-his_o[6,18])/his_o[6,18]*100
  cha_o7[i,18]=(pred_o7_global[i,55]-his_o[7,18])/his_o[7,18]*100
}
...
############################changes of output########################################
pred_o_global<- matrix(0, nrow = nrow(lm1_mcmc_p),ncol=n_2050-1)
for (i in 1:nrow(lm1_mcmc_y)){
  for (t in 1:n_2050-1){
    pred_o_global[i,t]=(pred_o1_global[i,t]+pred_o2_global[i,t]+pred_o3_global[i,t]+pred_o4_global[i,t]+pred_o5_global[i,t]+pred_o6_global[i,t]+pred_o7_global[i,t])
  }
}
o_global<- matrix(NA, nrow = 55, ncol =24)

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o1_global[,t])}  
uncertain_lower_reg <- apply(pred_o1_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o1_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,1]<- uncertain_lower_reg
o_global[,8]<- uncertain_mean_reg
o_global[,15]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o2_global[,t])}  
uncertain_lower_reg <- apply(pred_o2_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o2_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,2]<- uncertain_lower_reg
o_global[,9]<- uncertain_mean_reg
o_global[,16]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o3_global[,t])}  
uncertain_lower_reg <- apply(pred_o3_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o3_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,3]<- uncertain_lower_reg
o_global[,10]<- uncertain_mean_reg
o_global[,17]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o4_global[,t])}  
uncertain_lower_reg <- apply(pred_o4_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o4_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,4]<- uncertain_lower_reg
o_global[,11]<- uncertain_mean_reg
o_global[,18]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o5_global[,t])}  
uncertain_lower_reg <- apply(pred_o5_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o5_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,5]<- uncertain_lower_reg
o_global[,12]<- uncertain_mean_reg
o_global[,19]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o6_global[,t])}  
uncertain_lower_reg <- apply(pred_o6_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o6_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,6]<- uncertain_lower_reg
o_global[,13]<- uncertain_mean_reg
o_global[,20]<- uncertain_upper_reg


for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o7_global[,t])}  
uncertain_lower_reg <- apply(pred_o7_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o7_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,7]<- uncertain_lower_reg
o_global[,14]<- uncertain_mean_reg
o_global[,21]<- uncertain_upper_reg

for (t in 1:n_2050-1){uncertain_mean_reg[t,]<-median(pred_o_global[,t])}  
uncertain_lower_reg <- apply(pred_o_global, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(pred_o_global, MARGIN = 2, quantile, prob = 0.975)
o_global[,22]<- uncertain_lower_reg
o_global[,23]<- uncertain_mean_reg
o_global[,24]<- uncertain_upper_reg
...
cha_o<- matrix(NA, nrow =18,ncol=21)
for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o1[,t])}  
uncertain_lower_reg <- apply(cha_o1, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o1, MARGIN = 2, quantile, prob = 0.975)
cha_o[,1]<- uncertain_lower_reg
cha_o[,8]<- uncertain_mean_reg
cha_o[,15]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o2[,t])}  
uncertain_lower_reg <- apply(cha_o2, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o2, MARGIN = 2, quantile, prob = 0.975)
cha_o[,2]<- uncertain_lower_reg
cha_o[,9]<- uncertain_mean_reg
cha_o[,16]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o3[,t])}  
uncertain_lower_reg <- apply(cha_o3, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o3, MARGIN = 2, quantile, prob = 0.975)
cha_o[,3]<- uncertain_lower_reg
cha_o[,10]<- uncertain_mean_reg
cha_o[,17]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o4[,t])}  
uncertain_lower_reg <- apply(cha_o4, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o4, MARGIN = 2, quantile, prob = 0.975)
cha_o[,4]<- uncertain_lower_reg
cha_o[,11]<- uncertain_mean_reg
cha_o[,18]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o5[,t])}  
uncertain_lower_reg <- apply(cha_o5, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o5, MARGIN = 2, quantile, prob = 0.975)
cha_o[,5]<- uncertain_lower_reg
cha_o[,12]<- uncertain_mean_reg
cha_o[,19]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o6[,t])}  
uncertain_lower_reg <- apply(cha_o6, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o6, MARGIN = 2, quantile, prob = 0.975)
cha_o[,6]<- uncertain_lower_reg
cha_o[,13]<- uncertain_mean_reg
cha_o[,20]<- uncertain_upper_reg

for (t in 1:18){uncertain_mean_reg[t,]<-median(cha_o7[,t])}  
uncertain_lower_reg <- apply(cha_o7, MARGIN = 2, quantile, prob = 0.025)
uncertain_upper_reg <- apply(cha_o7, MARGIN = 2, quantile, prob = 0.975)
cha_o[,7]<- uncertain_lower_reg
cha_o[,14]<- uncertain_mean_reg
cha_o[,21]<- uncertain_upper_reg

####Fig.1 and 2################################
write.table(e_global, "E:/Data1_update/1.e_global.txt", sep="\t")
write.table(pred_e_global, "E:/Data1_update/1.pred_e_global.txt", sep="\t")
####Fig.S7################################
write.table(e_lower, "E:/Data1_update/2.e_lower.txt", sep="\t")
write.table(e_mean, "E:/Data1_update/2.e_mean.txt", sep="\t")
write.table(e_upper, "E:/Data1_update/2.e_upper.txt", sep="\t")
####Fig.S8################################
write.table(e1_mean, "E:/Data1_update/2.1.e1_mean.txt", sep="\t")
write.table(e2_mean, "E:/Data1_update/2.2.e2_mean.txt", sep="\t")
write.table(e3_mean, "E:/Data1_update/2.3.e3_mean.txt", sep="\t")
write.table(e4_mean, "E:/Data1_update/2.4.e4_mean.txt", sep="\t")
write.table(e5_mean, "E:/Data1_update/2.5.e5_mean.txt", sep="\t")
write.table(e6_mean, "E:/Data1_update/2.6.e6_mean.txt", sep="\t")
write.table(e7_mean, "E:/Data1_update/2.7.e7_mean.txt", sep="\t")
####Fig.S9################################
write.table(e_s_mean, "E:/Data1_update/2.8.e_s_mean.txt", sep="\t")
write.table(e_v_mean, "E:/Data1_update/2.9.e_v_mean.txt", sep="\t")
write.table(e_g_mean, "E:/Data1_update/2.10.e_g_mean.txt", sep="\t")

####Fig.3 and Fig.S10################################
write.table(fac_reg, "E:/Data1_update/3.fac_reg.txt", sep="\t")
####Fig.4 and Fig.S11################################
write.table(cha_ei, "E:/Data1_update/4.1.cha_ei.txt", sep="\t")
write.table(ei_global, "E:/Data1_update/4.2.ei_global.txt", sep="\t")
